...
hi PreProc guifg=Plum ctermfg=Magenta " Original
...
hi clear SignColumn " Added by Me!
hi CursorLine   cterm=NONE ctermbg=darkred ctermfg=white guibg=darkred guifg=white " Added by me!

" Python: {{{

" setf python " needed?
" hi! link pythonBuiltin PapayaWhip
" hi! link pythonBuiltinObj GruvboxOrange
" hi! link pythonbuiltinfunc magenta
hi pythonBuiltinFunc guifg=Magenta
hi! link pythonFunction Magenta
" hi! link pythonDecorator GruvboxRed
" hi! link pythonInclude GruvboxBlue
" hi! link pythonImport LightBlue3
hi link pythonImport guifg=LightBlue3
